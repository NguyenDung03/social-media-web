...
interface BrandDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  editingBrand: TBrand | null;
  formData: TFormBrand;
  setFormData: (data: TFormBrand) => void;
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      placeholder="Nhập tóm tắt về thương hiệu..."
                      value={formData.desc}
                      onChange={(e) =>
